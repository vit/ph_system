...
if(!$editorid>0) {
  $editorid=0;
  $editoridcond2 = "OR p.editor IS NULL";
}
...
FROM 
  paper AS p
  WHERE p.context=$CURRENTCONT AND (p.editor=$editorid $editoridcond2)
");
...
<br>
<center><span class=subtitle>Report: Papers with editor <i>"$editorid"</i> (short)<br>Found $n papers</span></center>
<p>
