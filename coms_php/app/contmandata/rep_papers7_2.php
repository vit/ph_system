...
<br>
<center><span class=subtitle>Report: Papers with final decision <i>"$decisiontitle"</i> (short),<br>ordered by title, authors<br>Found $n papers</span></center>
<p>
...
FROM 
  ...
  WHERE p.context=$CURRENTCONT AND (p.finaldecision=$decision $decisioncond2)
ORDER BY p.title, p.papnum, u.lname
");
