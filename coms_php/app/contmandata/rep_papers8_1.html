...
if(!$subject>0) {
  $subject=0;
  $subjectcond2 = "OR p.subject IS NULL";
}
...
FROM 
  paper AS p
  WHERE p.context=$CURRENTCONT AND (p.subject=$subject $subjectcond2)
");
...
<br>
<center><span class=subtitle>Report: Papers with author's subject <i>"$subjecttitle"</i> (detailed)<br>Found $n papers</span></center>
<p>
