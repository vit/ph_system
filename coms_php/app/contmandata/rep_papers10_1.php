...
$subject = (int)$_REQUEST['subject'];
$subjecttitle = $SUBJECTS[$subject];


$subjectcond2 = "";
if(!$subject>0) {
  $subject=0;
  $subjectcond2 = "OR p.finalsubject IS NULL";
}
...
FROM 
  paper AS p
  WHERE p.context=$CURRENTCONT AND (p.finalsubject=$subject $subjectcond2)
");
...
<br>
<center><span class=subtitle>Report: Papers with final subject <i>"$subjecttitle"</i> (detailed)<br>Found $n papers</span></center>
<p>
...
<!-- tr class=cell8>
<th colspan=3>Final subject and section</th>
</tr -->
<!-- tr class=cell4>
<th colspan=3>Editor's recommendations: score, subject, section, comments</th>
</tr>
<tr class=cell6>
<th colspan=3>Reviewer's recommendations: score, subject, section, comments</th>
</tr -->
...
<tr class=$cellclass2>
<th colspan=3>Authors (wit PINs)</th>
</tr>
<tr class=$cellclass2>
<th colspan=3>Keywords</th>
</tr>
...
//print_r( $row );
    ...
    $ed_subject = (int)$row['ed_recommendation'];
    $ed_subject_str = $EDITORPAPERsubjectS[$ed_subject];
    ...
    $r_subject = (int)$row['r_recommendation'];
    $r_subject_str = $REVIEWERPAPERsubjectS[$r_subject];
    ...
    $fin_subject = (int)$row['finalsubject'];
    $fin_subject_str = $FINALPAPERsubjectS[$fin_subject];
...
<tr class=$cellclass>
<td colspan=3><b>Authors (text):</b> $cauthors</td>
</tr>
<tr class=$cellclass>
<td colspan=3><b>Authors (with PINs):</b> $cauthors1</td>
</tr>
<tr class=$cellclass>
...
<!-- tr class=cell8>
<td colspan=3>
<b>Final subject:</b> <span class=selection3>$fin_subject_str</span>;
...
<b>Recommended subject:</b> <span class=selection1>$ed_subject_str</span>;
...
<b>Recommended subject:</b> <span class=selection2>$r_subject_str</span>;
